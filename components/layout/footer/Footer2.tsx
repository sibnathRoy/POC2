            ...
            <div className="row">
              <div className="col-lg-3 col-md-6">
                <Link className="navbar-brand pe-4" href="/">
                  <img src="/assets/imgs/template/logo.svg" alt="" />
                </Link>
                <p className="paragraph-base color-white pt-4 pb-2">
                  we denounce with righteous indignation and dislike men who are
                  so beguiled demoralized by the charms
                </p>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="d-flex flex-column align-items-start">
                  <Link
                    className="hover-effect paragraph-base grey-100 pt-4"
                    href="#">
                    Company
                  </Link>
                  <Link
                    className="hover-effect paragraph-base grey-100 pt-2"
                    href="#">
                    Careers
                  </Link>
                  <Link
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="pt-4">
                  <p className="paragraph-base color-white">
                    I’m okey with getting emails and having that tracked to
                ...
                <div className="pt-3">
                  <div className="form-newsletter">
                    <form action="#">
                      ...
                      />
                      <input type="" className="btn btn-newsletter" />
                    </form>
                  </div>
                </div>
              </div>
            ...
            <div className="container py-4">
              <div className="footer-bottom">
                <div className="row paragraph-base">
                  <div className="col">
                    <div className="small color-white">
                      Copyright © Vatech {new Date().getFullYear()} . Alright
                      Reserved.
                    </div>
                  </div>

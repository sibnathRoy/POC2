              ...
              <div className="box-header-right">
                ...
                <nav
                  className={`navbar navbar-expand-lg navbar-light w-100 ${
                    scroll ? "navbar-stick position-fixed top-0" : ""
                  }`}>
                  <ul className="navbar-nav gap-1 align-items-lg-center me-auto">
                    ...
                    <li className="nav-item dropdown menu-item-has-children">
                      ...
                      <ul className="dropdown-menu">
                        <li>
                          <Link className="dropdown-item" href="/about-us-2">
                            About Us
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li className="nav-item dropdown menu-item-has-children">
                      ...
                      <ul className="dropdown-menu">
                        <li>
                          <Link className="dropdown-item" href="/services-2">
                            Services 02
                          </Link>
                        </li>
                        <li>
                    ...
                    <li className="nav-item dropdown menu-item-has-children">
                      ...
                      <ul className="dropdown-menu">
                        <li>
                          <Link className="dropdown-item" href="/project">
                            Project List
                          </Link>
                        </li>
                        <li>
                    ...
                    <li className="nav-item dropdown menu-item-has-children">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li>
                          <Link className="dropdown-item" href="/team-detail">
                            Team Details
                          </Link>
                        </li>
                        <li>
                  ...
                  <div className="d-flex align-items-center box-header-right-buttons">
                    ...
                    <Link className="ms-4" href="/javascript:void(0)">
                      <img
                        src="/assets/imgs/template/icons/cart.svg"
                        alt="Vatech"
                      />
                    </Link>
                    <a
                      onClick={handleMobileMenu}
                      className="menu-tigger btn-navbar rounded-circle px-2 ms-4 d-flex align-items-center justify-content-center btn-menu">
                      <svg
                        width={30}
                        height={24}
                        viewBox="0 0 30 24"

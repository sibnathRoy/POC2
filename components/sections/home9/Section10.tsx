...
export default function Section10() {
	return (
		<>
			...
			<section className="position-relative overflow-hidden box-latest-blog-3 box-latest-blog-9">
				<div className="container">
					<div className="row position-relative align-items-end">
						<div className="col-lg-9 mb-4 text-center text-lg-start">
							<h6 className="sub-heading-ag-sm primary-500 text-uppercase mb-2">Latest blog</h6>
									...
									<div className="row position-relative">
										<div className="col-lg-6">
											<div className="card-blog card-blog-3">
												<div className="card-image">
													<Link href="#"><img src="/assets/imgs/pages/home9/news.png" alt="Vatech" /></Link>
										...
										<div className="col-lg-6">
											<div className="card-blog card-blog-4">
												<div className="card-image">
													<Link href="#"><img src="/assets/imgs/pages/home9/news2.png" alt="Vatech" /></Link>
												</div>
												<div className="card-info">
													<div className="card-meta">
														<span className="comment">Comments</span>
											...
											<div className="card-blog card-blog-4">
												<div className="card-image">
													<Link href="#"><img src="/assets/imgs/pages/home9/news3.png" alt="Vatech" /></Link>
												</div>
												<div className="card-info">
													<div className="card-meta">
														<span className="comment">Comments</span>
